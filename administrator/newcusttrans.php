...
<!--MAIN--->
 ...
 <?php 
                                                 ...
                                                 $checkifproductExisttrue= "select * from trans_record where prod_id = '$prodid' and invoice_no ='$invoice_no' and stat_checkout ='true' and transaction_type = 'checkout' and status = 'approved' ";
                                                   ...
                                                   <!--end of -->
                                                    ...
                                                    <?php
                                                      ...
                                                      $insertnewdata = "INSERT INTO `trans_record`( `invoice_no`, `user_id`, `prod_id`, `quantity`, `total`, `dateandtime`, `transaction_type`, `Order_accepted`, `target_date`,`status`,`stat_checkout`) VALUES ('$invoice_no','$userid','$prodid','$Qty','$total',now(),'checkout',now(),now(),'approved','true')";
  ...
  <tbody  style="height: 10px !important; overflow: scroll; ">
                          ...
                          $sqlselect = "SELECT * FROM `newcusttrans` ";
