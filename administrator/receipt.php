                       ...
                       while($row = mysqli_fetch_array($result)){
                                $branchname = $row['bname'];
                                 $branchlocation = $row['location'];
                                  ...
                                  $selectuser = "select * from user_account where user_id = '$userid'";
                                  $resulta = mysqli_query($con,$selectuser); // run query
 ...
 <div style="width:100%;height:100%;background-color:white;">
 	...
 	<div class="" style="float: right">
 	 ...
 	 <!--end of -->
 	  	...
 	  	<h5>Sold TO :
 	  		<br>
 	  		Name :<?php echo $name?>, <?php echo $surname?>
 	  		<br>
    	...
    	<table >
    		...
    		<tbody>
                        <?php 
                                ...
                                $sql = "select * from receipt where user_id = '$userid' and invoice_no = '$invoice' and transaction_type = 'checkout' and stat_checkout='completed' and status = 'completed'  ";
