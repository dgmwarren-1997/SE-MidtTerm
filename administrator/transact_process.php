...
<!--MAIN--->
 ...
 <?php 
                                              ...
                                              $result = mysqli_query($con,$sql); // run query
                                               ...
                                               /*  $updateproductstock = "UPDATE `product` SET`stock`='$stockupdate' WHERE prod_id = '$prodid'";
                                                $resultofupdate = mysqli_query($con,$updateproductstock); // run query*/
                                                 ...
                                                 $checkifproductExisttrue= "select * from trans_record where prod_id = '$prodid' and invoice_no ='$invoice_no' and stat_checkout ='true' and transaction_type = 'walk in' and status = 'approved' ";
                                                    $resultcheckedtrue = mysqli_query($con,$checkifproductExisttrue);
                                                     $countfortrue= mysqli_num_rows($resultcheckedtrue); // to count if necessary
                                                        ...
                                                        $checkifproductExistfalse= "select * from trans_record where prod_id = '$prodid' and  invoice_no ='$invoice_no' and stat_checkout ='false' and transaction_type = 'walk in' and status = 'approved' ";
                                                   ...
                                                   <!--end of -->
                                                    ...
                                                    <?php
                                                      ...
                                                      $insertnewdata = "INSERT INTO `trans_record`( `invoice_no`, `user_id`, `prod_id`, `quantity`, `total`, `dateandtime`, `transaction_type`, `Order_accepted`, `target_date`,`status`,`stat_checkout`) VALUES ('$invoice_no','$userid','$prodid','$Qty','$total',now(),'walk in',now(),now(),'approved','true')";
  ...
  <tbody  style="height: 10px !important; overflow: scroll; ">
                          ...
                          $sqlselect = " select * from walkin where  invoice_no = '$invoice_no'  and transaction_type = 'walk in' and status = 'approved'  ";
              ...
              <div class="card-body">
                      ...
                      <br>
                       ...
                       CASH PAY-IN <i class="fas fa-file-invoice"></i>
                        ...
                        <a href="accessor.php?cancelid=<?php echo $invoice_no ?>" class="form-control btn btn-danger" style="height: 50px;margin-top: 20px;">CANCEL</a>
