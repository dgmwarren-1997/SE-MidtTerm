...
<!--MAIN--->
 ...
 <?php 
                                     ...
                                     <div class="alert alert-success" role="alert">
                                      ...
                                      <script type="text/javascript">
                                             ...
                                             setTimeout(function(){ 
                                                        ...
                                                        window.location.href = "paymentnouser.php?btnpayin&invoice=<?php echo $invoice?>&txtamount=<?php echo $txtamount?>&txtchange=<?php echo $txtchange?>&totalcost=<?php echo $totalcost?>&userid=<?php echo $userid?>";
                                                         }, 3000);        
                                              ...
                                              $result = mysqli_query($con,$sql); // run query
                                               ...
                                               $stockupdate = $stock-$Qty; 
                                                ...
                                                if ($resultofupdate) { 
                                                 ...
                                                 $checkifproductExisttrue= "select * from trans_record where prod_id = '$prodid' and invoice_no ='$invoice_no' and stat_checkout ='true' and transaction_type = 'checkout' and status = 'approved' ";
                                                   ...
                                                   <!--end of -->
                                                    ...
                                                    <?php
                                                      ...
                                                      $insertnewdata = "INSERT INTO `trans_record`( `invoice_no`, `tempuserid`, `prod_id`, `quantity`, `total`, `dateandtime`, `transaction_type`, `Order_accepted`, `target_date`,`status`,`stat_checkout`) VALUES ('$invoice_no','$userid','$prodid','$Qty','$total',now(),'checkout',now(),now(),'approved','true')";
  ...
  <tbody  style="height: 10px !important; overflow: scroll; ">
                          ...
                          $sqlselect = "SELECT * FROM `newtrans`";
                                     ...
                                     //while($row = mysqli_fetch_array($result)){} is where we output all the data in database
                                      ...
                                      if ($count>=1){
                                       ...
                                       ?>
                                       <tr>
                                         <td>Add item click <a href="#" data-toggle="modal" data-target="#Addnew">HERE</a>.</td>
                                       </tr>
                                       <?php
                                      }
              ...
              <div class="card-body">
                      ...
                      <br>
                       ...
                       CASH PAY-IN <i class="fas fa-file-invoice"></i>
                                ...
                                $sqlselect = "SELECT * FROM `newtrans` ";
                                     ...
                                     //while($row = mysqli_fetch_array($result)){} is where we output all the data in database
                                      ...
                                      if ($count>=1){
                                        ...
                                        ?>
                                        <h6>TOTAL  COST: <strong style="color:red;font-size: 25px">₱  <?php echo  $totalcostdue?></strong></h6>
                                        <?php
                                      
                                      }else {
                                          ?>
                                        <h6>TOTAL  COST: <strong style="color:red;font-size: 25px">₱ 0</strong></h6>
                                        <?php 
                                      }
                                ?>
                                      Amount Rendered :
                                      ...
                                      <br><br>
                                      CHANGE :
                                      <input type="text" name="txtchange" class="form-control" id="total" style="height: 50px" readonly="" placeholder="0" >
                                      <br><br>                    
                        ...
                        <a href="accessor.php?cancelnew=<?php echo $invoice_no ?>" class="form-control btn btn-danger" style="height: 50px;margin-top: 20px;">CANCEL</a>
